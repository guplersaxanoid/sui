...
impl MergedValue {
    fn add_move_call(
        ...
        let checkpoint_seq = 1337u64; /* TODO: replace with actual checkpoint sequence number */
            ...
            } in events
            {
                ...
                match operation {
                    AccumulatorOperation::Merge => {
                        entry.merge.accumulate_into(value, checkpoint_seq, tx_index as u64);
                    }
                    AccumulatorOperation::Split => {
                        entry.split.accumulate_into(value, checkpoint_seq, tx_index as u64);
                    }
                }
            }
        }
