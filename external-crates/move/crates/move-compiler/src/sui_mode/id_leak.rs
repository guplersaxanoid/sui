...
use crate::{
    ...
    sui_mode::{
        ...
        CLOCK_MODULE_NAME, DENY_LIST_CREATE, DENY_LIST_MODULE_NAME, DERIVED_OBJECT_MODULE_NAME,
        ID_LEAK_DIAG, OBJECT_MODULE_NAME, OBJECT_NEW, OBJECT_NEW_UID_FROM_HASH,
        RANDOMNESS_MODULE_NAME, RANDOMNESS_STATE_CREATE, SUI_ADDR_NAME, SUI_ADDR_VALUE,
        SUI_CLOCK_CREATE, SUI_SYSTEM_ADDR_VALUE, SUI_SYSTEM_CREATE, SUI_SYSTEM_MODULE_NAME,
...
pub const FRESH_ID_FUNCTIONS: &[(AccountAddress, Symbol, Symbol)] = &[
    ...
    (SUI_ADDR_VALUE, DERIVED_OBJECT_MODULE_NAME, OBJECT_NEW),
